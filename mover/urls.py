...
from .views import (document_verification, login, logout_view, fulfill_request,
                    ...
                    ready_to_move, test_cordinates, vehicle_information, list_fulfilled_requests,
                    ready_to_move_customer, before_moving, send_email)

urlpatterns = [
    path('', index, name="index"),
    path('test-cordinates/', test_cordinates, name="cordinates"),
    ...
    path("fulfilled-requests/", list_fulfilled_requests,
         name="list_fulfilled_requests"),
